...
In short: we built a simulation from the ground up in Python and then implemented several path planning algorithms to find a path through an obstacle course. Then we simulated a quadrotor drone with limited propellor control to execute this trajectory.
